import { Box, Button, Flex, FlexProps, Link } from '@chakra-ui/react';
import NextLink from 'next/link';
import { ReactNode } from "react"

interface LayoutDefaultProps extends FlexProps {
  children: ReactNode
}

const LayoutDefault = ({ children, ...props }: LayoutDefaultProps) => {
  return (
    <Flex w="100%" justifyContent="center" alignItems="center" height="100vh" {...props}>
